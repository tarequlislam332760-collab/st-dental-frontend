...
const Home = ({ lang }) => {
  ...
  // API data থাকলে সেটা ব্যবহার করো, না থাকলে default
  const heroData = {
    bn: [
      {
        title: (heroApi?.heroTitleBn) || 'সেরা ডেন্টাল চিকিৎসা',
        sub:   (heroApi?.heroSubBn)   || 'Premium Dental Care',
        desc:  (heroApi?.heroDescBn)  || 'আধুনিক প্রযুক্তিতে আমরা নিশ্চিত করি আপনার সুন্দর হাসি।',
      ...
      },
      {
        ...
        sub:   (heroApi?.heroSubBn)   || 'Expert Facial & Skin',
    ...
    en: [
      {
        title: (heroApi?.heroTitleEn) || 'Best Dental Care',
        sub:   (heroApi?.heroSubEn)   || 'Premium Dental Care',
        desc:  (heroApi?.heroDescEn)  || 'We ensure your beautiful smile with modern technology.',
      ...
      },
      {
        ...
        sub:   (heroApi?.heroSubEn)   || 'Expert Facial & Skin',

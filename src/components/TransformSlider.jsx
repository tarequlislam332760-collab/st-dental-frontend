    ...
    <section className="py-24 px-6 bg-black">
      <div className="max-w-5xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <div className="text-left">
            <h2 className="text-4xl font-black text-white uppercase italic leading-none">
              {t.title} <br /> <span className="text-[#D4AF37]">{t.titleGold}</span>
            </h2>
            <p className="text-[10px] text-gray-600 uppercase tracking-[4px] mt-4 font-bold">{t.sub}</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* Dental Slider */}
          <div className="group">
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase mb-4 tracking-widest text-center">{t.dental}</p>
          ...
          {/* Facial Slider */}
          <div className="group">
            <p className="text-[#D4AF37] text-[10px] font-bold uppercase mb-4 tracking-widest text-center">{t.facial}</p>
            <div className="rounded-[32px] overflow-hidden border border-white/5 shadow-2xl transition-transform duration-700 group-hover:scale-[1.02]">
              <ReactCompareImage
